...
<div id="wrapper">
  ...
  <div id="main" class="clearfix">
    <div id="primary">
      <section id="content" role="main">
        ...
        <?php print $messages; ?>
        <?php if (!empty($page['content_top'])): ?><div id="content_top"><?php print render($page['content_top']); ?></div><?php endif; ?>
        <div id="content-wrap">
  ...
  <footer id="footer-bottom">
    <div id="footer-area" class="clearfix">
      <?php if (!empty($page['footer_first']) || !empty($page['footer_second']) || !empty($page['footer_third'])): ?>
